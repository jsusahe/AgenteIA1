...
def generate_html_document(summary_data, audio_filename, output_filename="index.html"):
    ...
    # --- Asegurar que audio_filename es solo el nombre del archivo ---
    audio_filename_clean = os.path.basename(audio_filename) if audio_filename else "resumen_ia.mp3"
    print(f"🔊 Audio para HTML: {audio_filename_clean}")
