...
def generate_html_document(summary_data, audio_filename, output_filename="index.html"):
    ...
    Args:
        ...
        audio_filename (str): Nombre del archivo de audio (se ignora, se usa siempre "resumen_ia.mp3")
    ...
    # --- FORZAR EL USO DE resumen_ia.mp3 ---
    # Este es el nombre fijo que se copia en la raíz del sitio en el PASO 6 de main.py
...
if __name__ == '__main__':
    ...
    print("\n✅ Archivo test_index.html generado.")