...
def run_agent():
    ...
    try:
        ...
        if not youtube_videos:
            ...
            # Mostrar los canales encontrados
            canales = set()
    ...
    try:
        ...
        # Asegurar que al menos una noticia de cada canal de YouTube esté en el resumen
