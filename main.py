...
MAX_HISTORY_DAYS = 10
TOP_NEWS_LIMIT = 15   # Aumentado para tener más noticias externas disponibles
...
def run_agent():
    ...
    # Verificar si hay suficientes noticias
    ...
    if total_available < MIN_NEWS_TOTAL:
        ...
        # Intentar obtener más noticias externas
        if len(external_news) < MIN_NEWS_TOTAL:
            ...
            if additional_news:
                # Añadir noticias adicionales que no estén ya en la lista
