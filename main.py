...
def run_agent():
    ...
    # --- NUEVO PASO 0: DESCARGAR HISTÓRICOS ANTES DE GENERAR EL CONTENIDO ---
    print("\n🔄 PASO 0: Descargando históricos desde Google Drive antes de generar el contenido...")
    try:
    ...
    # --- PASO 4: Generar documento HTML con fecha (AHORA CON HISTÓRICOS YA DESCARGADOS) ---
