...
def run_agent():
    ...
    try:
        ...
        # Continuamos con el resto de fuentes aunque falle YouTube

    # --- PASO 1.5: Obtener noticias de fuentes externas ---
    ...
    try:
        ...
        if not external_news:
            ...
            print(f"✅ Se seleccionaron {len(external_news)} noticias relevantes de fuentes externas.")
    except Exception as e:
        print(f"⚠️ Error al obtener noticias externas: {e}")
        # Continuamos aunque falle la obtención de noticias externas

    # --- PASO 2: Combinar noticias y generar resumen ---
    print("\n🧠 PASO 2: Generando resumen combinado con DeepSeek...")
    
    # Si no hay noticias de ninguna fuente, generar documento "sin novedades"
    ...
    # Preparar la lista combinada de noticias para el resumen
    combined_news = []
