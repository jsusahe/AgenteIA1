...
def run_agent():
    ...
    html_filename = get_daily_filename("resumen", "html")
    try:
        # NOTA: document_generator.py ahora ignora este parámetro y usa "resumen_ia.mp3"
        html_file = generate_html_document(
            summary_data, 
            "resumen_ia.mp3",  # Pasar el nombre fijo para claridad
            html_filename
        )
    ...
    try:
        ...
        # Copiar el audio más reciente como resumen_ia.mp3
