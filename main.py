...
def run_agent():
    ...
    # --- PASO 1 a 8: (Código existente sin cambios) ---
    ...
    try:
        # Descargar todos los históricos desde Drive
        download_history_from_drive(HISTORY_FOLDER)
        
        # Regenerar index.html con los históricos descargados
        print("\n📄 Regenerando index.html con los históricos actualizados...")
        
        # Cargar el resumen del día actual (para mantener el contenido)
        # Usamos el summary_data que ya tenemos
        updated_html = generate_html_document(
            summary_data, 
            "resumen_ia.mp3",
            "index.html"  # Sobrescribe el index.html
        )
