...
def generate_summary(news_items):
    ...
    **INSTRUCCIONES OBLIGATORIAS:**
    ...
    try:
        ...
        print(f"\n📝 Respuesta de DeepSeek (primeros 300 caracteres): {ai_response_content[:300]}...")
        ...
        try:
            ...
            cleaned = re.sub(r'^[^{]*', '', ai_response_content)
        ...
        if summary_data is None:
            print("❌ No se pudo extraer JSON. Usando modo de respaldo.")
