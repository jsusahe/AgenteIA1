...
def generate_summary(news_items):
    ...
    **IMPORTANTE:** NO devuelvas textos en inglés. Todo el contenido debe estar en español.
    ...
    user_prompt = f"Aquí está la lista de noticias recopiladas del día (algunas pueden estar en inglés, pero tú debes traducirlas al español):\n\n{news_info_text}"
...
if __name__ == '__main__':
    ...
    test_news = [
        ...
        },
        {
            ...
            "resumen": "Microsoft pitched its own homegrown AI models, harnesses, and even a Mythos competitor.",
            "fuente": "TechCrunch",
