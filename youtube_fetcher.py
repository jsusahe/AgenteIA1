...
def get_transcript(video_id):
    """
    Obtiene la transcripción de un video usando yt-dlp con múltiples estrategias.
    """
    ydl_opts = {
        'quiet': True,
        'skip_download': True,
...
def get_transcript_fallback(video_id):
    """
    Estrategia de respaldo: intentar obtener solo subtítulos sin formato de audio.
    """
